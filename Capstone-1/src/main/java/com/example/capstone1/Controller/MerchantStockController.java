...
public class MerchantStockController {
    ...
    public ResponseEntity AddMoreStocks (@PathVariable String merchantId, @PathVariable String productId,@PathVariable int stocks){
    ...
    public ResponseEntity discountProductsByMerch (@PathVariable String merchantId, @PathVariable int percentage){
